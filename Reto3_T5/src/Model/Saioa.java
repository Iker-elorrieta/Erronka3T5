...
public class Saioa {
	...
	public String toString() {
		return "Ordua=" + (ordua.get(Calendar.HOUR)+12)+":"+ordua.get(Calendar.MINUTE)+", data="+ordua.get(Calendar.DAY_OF_MONTH)+"-"+ordua.get(Calendar.MONTH)+"-"+ordua.get(Calendar.YEAR)+ ", "+filma;
	}
